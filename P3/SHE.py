...
def sistemaHormigas():
    ...
    for seed in semillas:
        ...
        while tiempo_ejecucion < 300:
            ...
            #Actualizo feromonas elitistas
            for j in range(1,len(mejorSolGLobal)):
                ciudad1 = int(mejorSolGLobal[j-1])
                ciudad2 = int(mejorSolGLobal[j])
                t[ciudad1, ciudad2] += (e / mejorCosteGlobal)
                t[ciudad2, ciudad1] = copy.copy(t[ciudad1, ciudad2])
        ...
        fAux.dibujaCamino(mejorSolGLobal, ciudades,"SHE"+str(seed))
